...
pub struct OntologyData {
    pub classes: Vec<visionclaw_domain::ports::ontology_repository::OwlClass>,
    pub properties: Vec<visionclaw_domain::ports::ontology_repository::OwlProperty>,
    pub axioms: Vec<visionclaw_domain::ports::ontology_repository::OwlAxiom>,
}
