...
pub struct OntologyData {
    pub classes: Vec<visionflow_domain::ports::ontology_repository::OwlClass>,
    pub properties: Vec<visionflow_domain::ports::ontology_repository::OwlProperty>,
    pub axioms: Vec<visionflow_domain::ports::ontology_repository::OwlAxiom>,
}
