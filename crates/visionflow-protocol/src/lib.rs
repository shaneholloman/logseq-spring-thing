//! Wire-protocol encode/decode for VisionFlow.
//!
...
//!   Uses [`visionflow_domain::BinaryNodeData`] as the canonical data type.
//!
//! # Webxr shim
//!
...
pub use binary_protocol::{
    ...
    // Encode/decode functions (operate on visionflow_domain::BinaryNodeData)
