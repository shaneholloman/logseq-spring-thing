          ...
          socket.onmessage = (event: MessageEvent) => {
            ...
            try {
              ...
              if (message.type === 'initialGraphLoad') {
                ...
                // FIX 1: initialGraphLoad race — if REST already loaded more nodes,
                // skip the setGraphData call. The REST path loads all 963 nodes; the WS
                // initialGraphLoad typically sends only ~200. Don't let 200 overwrite 963.
