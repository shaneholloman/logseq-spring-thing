...
description: >
  ...
  Claude, Copilot. Analyzes content for AI-friendliness and applies optimization
  techniques including quotable statements, Q&A formatting, authority signals,
  and source attribution. Use when asked to "optimize for AI", "get cited by
  ChatGPT", "AI optimization", "GEO optimization", "appear in AI answers",
  "generative engine optimization", "make content AI-quotable", or any AI
  citation task.
---
...
1. **Load CORE-EEAT GEO-First Optimization Targets**
   ...
   Before optimizing, load GEO-critical items from the CORE-EEAT Benchmark:
   ...
   **AI Engine Preferences**:
   ...
   _Full benchmark: CORE-EEAT Benchmark_
   ```
...
5. **CORE-EEAT GEO Self-Check**
    ...
    **Items Needing Attention**: [list any ⚠️/❌ items]
    ...
    _For full 80-item audit, use content-quality-auditor_
    ```
...
- **Primary**: [content-writer](../content-writer/SKILL.md) — create or improve content using the GEO-optimized approach.
