...
AgentTelemetry events into the `urn:visionclaw:graph:agent` named graph.
...
```json-ld
{
  ...
  "@id": "urn:visionclaw:agent:run-2026-05-16-001:step-0",
  "@type": "AgentTelemetry",
  ...
  "vc:namedGraph": { "@id": "urn:visionclaw:graph:agent" },
  "vc:metrics": {
...
{
  "@context": "https://narrativegoldmine.com/context/v1.jsonld",
  "@id": "urn:visionclaw:agent:run-2026-05-16-001:step-1",
  "@type": "AgentTelemetry",
  "vc:agentDid": { "@id": "did:nostr:npub1whelk00000000000000000000000000000000000000000000000000000" },
  "vc:runId": "run-2026-05-16-001",
  "vc:step": 1,
