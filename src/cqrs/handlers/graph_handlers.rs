...
impl QueryHandler<GetNodeQuery> for GraphQueryHandler {
    async fn handle(&self, query: GetNodeQuery) -> Result<Option<visionclaw_domain::models::node::Node>> {
...
impl QueryHandler<GetNodesQuery> for GraphQueryHandler {
    async fn handle(&self, query: GetNodesQuery) -> Result<Vec<visionclaw_domain::models::node::Node>> {
        query.validate()?;
...
impl QueryHandler<GetAllNodesQuery> for GraphQueryHandler {
    async fn handle(&self, _query: GetAllNodesQuery) -> Result<Vec<visionclaw_domain::models::node::Node>> {
...
impl QueryHandler<SearchNodesQuery> for GraphQueryHandler {
    async fn handle(&self, query: SearchNodesQuery) -> Result<Vec<visionclaw_domain::models::node::Node>> {
        query.validate()?;
        Ok(self
            .repository
...
impl QueryHandler<GetNodesByMetadataQuery> for GraphQueryHandler {
    ...
    ) -> Result<Vec<visionclaw_domain::models::node::Node>> {
        query.validate()?;
        Ok(self
            .repository
...
impl QueryHandler<GetNodeEdgesQuery> for GraphQueryHandler {
    async fn handle(&self, query: GetNodeEdgesQuery) -> Result<Vec<visionclaw_domain::models::edge::Edge>> {
...
impl QueryHandler<GetEdgesBetweenQuery> for GraphQueryHandler {
    async fn handle(&self, query: GetEdgesBetweenQuery) -> Result<Vec<visionclaw_domain::models::edge::Edge>> {
        Ok(self
            .repository
...
impl QueryHandler<GetNeighborsQuery> for GraphQueryHandler {
    async fn handle(&self, query: GetNeighborsQuery) -> Result<Vec<visionclaw_domain::models::node::Node>> {
...
impl QueryHandler<LoadGraphQuery> for GraphQueryHandler {
    async fn handle(&self, _query: LoadGraphQuery) -> Result<Arc<visionclaw_domain::models::graph::GraphData>> {
...
impl QueryHandler<QueryNodesQuery> for GraphQueryHandler {
    async fn handle(&self, query: QueryNodesQuery) -> Result<Vec<visionclaw_domain::models::node::Node>> {
        query.validate()?;
