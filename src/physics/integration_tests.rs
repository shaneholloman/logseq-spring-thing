...
mod tests {
    ...
    fn create_test_constraints() -> ConstraintSet {
        ...
        constraint_set.add(visionclaw_domain::models::constraints::Constraint::fixed_position(
            1, 0.0, 0.0, 0.0,
        ));
        constraint_set.add(visionclaw_domain::models::constraints::Constraint::separation(
            2, 3, 100.0,
        ));
