...
use visionclaw_domain::ports::inference_engine::{InferenceEngine, Result as EngineResult};
use visionclaw_domain::ports::ontology_repository::{OntologyRepository, InferenceResults};
