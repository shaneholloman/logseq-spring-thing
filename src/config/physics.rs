...
impl Default for PhysicsSettings {
    fn default() -> Self {
        Self {
            ...
            // Viewport-calibrated defaults (2026-04-30):
            // For 22k nodes visible at camera (0,10,50) FOV 75° → target
            // visible radius ~30-50 units. Equilibrium inter-node distance
            // ~2 units gives a tight but legible graph that fits frame.
            // No scalers anywhere — these are the literal values used by
            // both ForceCompute and the YAML-defaults fallback path.
            bounds_size: 100.0,
